    ...
    <div className="item">
      <div className="card">
        <a href={`${url}/singleitem/${slug}`}>
          <img className="img" src={images[0].url} alt="Unable to load" />
        </a>
        <div className="side">
          <div className="details">
            ...
            <div className="small-details">
              ...
              <p>
                <span>Price:</span>
                <span style={{ fontWeight: "600" }}>Rs.{bagprice}</span>
              </p>
            </div>
          </div>
          <div className="buttons big">
            ...
            <div className="dropdown">
              <Dropdown
                height={40}
                curr={quantity}
                setCurr={(curr) => handlesetQuantity(curr)}
                options={[...Array(qty - 1).keys()].map((x) => (x = x + 1))}
              />
            </div>
          </div>
        </div>
        <span className="close" onClick={() => handleremoveFromBag(slug)}>
          <RiCloseLine size={24} />
        </span>
      </div>
