        ...
        <div className="side">
          <div className="details">
            ...
            <div className="small-details">
              <span className="align">Brand: </span>
              <span>{brand}</span>
              <span className="align">Color: </span>
              <span>{color}</span>
            </div>
          </div>
          <div className="buttons big">
            <div className="dropdown">
              <Dropdown
                height={40}
                curr={size}
                setCurr={(curr) => setSize(curr)}
                options={["M", "S", "L", "XL"]}
              />
            </div>
            <button onClick={() => handleBagClick({ item, size, slug })}>
              <FiShoppingBag size={20} />
              <span>Add</span>
            </button>
          </div>
        </div>
        <span className="close" onClick={() => removeFav(item, slug)}>
          <RiCloseLine size={24} />
        </span>
      </div>
